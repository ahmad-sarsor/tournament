...
אתר לניהול טורנירים (בערבית, RTL) — לוח משחקים + טבלאות דירוג וסטטיסטיקות שמתעדכנות אוטומטית, פאנל ניהול להזנת תוצאות ואירועים (כולל שער עצמי), ותמיכה בכמה טורנירים. חשבון עם מייל מאומת פעיל מיד; חשבון בלי מייל נשאר בהמתנה עד אישור הבעלים.
