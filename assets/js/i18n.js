...
export const t = {
  ...
  usernamePlaceholder: "ahmad2010",
  usernameHint: "فريد ولا يتكرر: يبدأ بحرف إنجليزي، ثم حروف وأرقام و - و _ بلا مسافات. مثال: ahmad2010",
  usernameInvalid: "اسم المستخدم 3-24 محرفاً، يبدأ بحرف إنجليزي، ثم حروف/أرقام/-/_ بلا مسافات",
  ...
  accountPortalTitle: "حسابك في المنصّة",
  accountPortalSubLogin: "سجّل الدخول لإدارة بطولاتك",
  accountPortalSubSignup: "أنشئ حساباً لإنشاء بطولاتك وإدارتها",
  forgotEmailOnly: "استعادة كلمة المرور متاحة للحسابات ذات البريد فقط. لحساب اسم المستخدم، تواصل مع إدارة المنصّة.",
  // إدارة المستخدمين: حذف دائم + استعادة + التحقّق من اسم المستخدم للطاقم
  removedBadge: "مُزال",
  showRemoved: "عرض المُزالين",
  hideRemoved: "إخفاء المُزالين",
  restoreUser: "استعادة",
  deleteUserQ: "حذف «{name}» نهائياً؟ سيُحظر من المشاركة ويُزال من القوائم ويتحرّر اسمه — يمكنك استعادته لاحقاً من «عرض المُزالين».",
  userRemovedDone: "تمّت إزالة المستخدم وحظره",
  userRestoredDone: "تمّت استعادة المستخدم",
  staffUserNotFound: "لا يوجد مستخدم مسجَّل بهذا الاسم — اطلب منه التسجيل أولاً، ثم عيّنه.",
  ...
  koDrawNotAllowed: "التعادل غير ممكن في الأدوار الإقصائية — حدّد فائزاً (بركلات الترجيح مثلاً) قبل الإنهاء.",
  ...
  authErrors: {
    ...
    "app/invalid-username": "اسم المستخدم 3-24 محرفاً، يبدأ بحرف إنجليزي، ثم حروف/أرقام/-/_ بلا مسافات",
  ...
  noScorersYet: "لم تُسجَّل أهداف بأسماء اللاعبين بعد.",
  noCardsYet: "لا توجد بطاقات مسجَّلة.",
  goalsNote: "تُحتسب القائمة من الأهداف المسجَّلة بأسماء اللاعبين — الهدف العكسي لا يُحتسب لمسجِّله.",
  cardsSortNote: "مرتَّبة حسب الطرد ثم الإنذارات",
  teamStatsSortNote: "مرتَّبة حسب الأكثر تسجيلاً للأهداف",
  thGfFull: "الأهداف المسجَّلة (له)",
  thGaFull: "الأهداف المستقبَلة (عليه)",
  thGdFull: "فارق الأهداف",
  teamDetails: "الفريق",
  ...
  addGoal: "تسجيل هدف",
  ownGoal: "هدف عكسي",
  ownGoalHint: "لاعب من هذا الفريق سجّل في مرماه — يُحتسب الهدف للفريق الآخر",
  ownGoalMark: "(عكسي)",
  whoOwnGoal: "مَن سجّل في مرمى فريقه؟",
  yellowCard: "إنذار",
  redCard: "طرد",
