...
export const t = {
  ...
  pendingBody: "تمّ تسجيل حسابك بنجاح. لا تستطيع إنشاء تورنيرات بعد — بانتظار أن يعتمدك مالك المنصّة. (يمكن أن يعيّنك صاحب تورنير مديراً في تورنيره.)",
  ...
  registerIntro: "للمشاركة، سجّل بياناتك مرّة واحدة على هذا الجهاز ثم أدخِل توقّعاتك.",
  regName: "الاسم الثلاثي",
  regNamePlaceholder: "الاسم الأول واسم الأب واسم العائلة",
  regPhone: "رقم الهاتف",
  regPhonePlaceholder: "05xxxxxxxx",
  regEmail: "البريد الإلكتروني (بديل الهاتف)",
  regContactHint: "أدخل رقم الهاتف أو البريد الإلكتروني (أحدهما على الأقل).",
  regAge: "العمر",
  ...
  anonDisabled: "المشاركة غير مفعّلة بعد. على مدير المنصّة تفعيل «الدخول المجهول» (Anonymous) في إعدادات Firebase Authentication.",
  ...
  otpBack: "تعديل الرقم",
  otpSkip: "المتابعة دون توثيق الهاتف",
  otpSkipHint: "دون توثيق، تبقى مشاركتك مربوطة بهذا الجهاز فقط.",
